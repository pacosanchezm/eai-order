...
const CtxConfirmado = createContext(null);
...
const useStateUniv = () => {
  return {
    ...
    Confirmado: useState(useContext(CtxConfirmado)),
...
const Pie = props => {
  ...
  const [Confirmado] = useContext(StateContextM).Confirmado;
...
const Router = props => {
  ...
  const [Confirmado, setConfirmado] = useContext(StateContextM).Confirmado;
